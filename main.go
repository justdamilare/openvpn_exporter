...
func main() {
	var (
		...
		openvpnStatusPaths = flag.String("status-files", "/var/log/openvpn/engineering-m01.status,/var/log/openvpn/employee-m01.status,/var/log/openvpn/contractor-m01.status", "Paths at which OpenVPN places its status files.")
